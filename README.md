-- if u wanna skid i dont give a fuc go ahead
if game.CoreGui:FindFirstChild("SysBroker") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "c4xc4x gui",Text = "GUI Already loaded, rejoin to re-execute",Duration = 5;})
	return
end
local version = 2
...
TitleBarLabel.Text = "____/C4XC4X GUI\\___"
...
Credits_Label.Text = "Made by: c4xc4x \nDiscord: discord.gg/mbzmCap7VV\nVersion: "..version
...
local function UpdateTarget(player)
	pcall(function()
		if table.find(ForceWhitelist,player.UserId) then
			SendNotify("c4xc4x gui","You cant target this player: @"..player.Name.." / "..player.DisplayName,5)
			player = nil
		end
	end)
	if (player ~= nil) then
...
CMDBar.FocusLost:Connect(function()
	...
	SendNotify("c4xc4x gui",("Executed "..command),5)
	CMDBar.Text = ""
end)
...
WalkSpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("c4xc4x gui","Walk speed updated.",5)
	end)
end)
...
JumpPower_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("c4xc4x gui","Jump power updated.",5)
	end)
end)
...
FlySpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("c4xc4x gui","Fly speed updated.",5)
	end)
end)
...
SaveCheckpoint_Button.MouseButton1Click:Connect(function()
	...
	SendNotify("c4xc4x gui","Checkpoint saved.",5)
end)

ClearCheckpoint_Button.MouseButton1Click:Connect(function()
	SavedCheckpoint = nil
	SendNotify("c4xc4x gui","Checkpoint cleared.",5)
end)
...
WhitelistTarget_Button.MouseButton1Click:Connect(function()
	if TargetedPlayer ~= nil then
		if table.find(ScriptWhitelist, Players[TargetedPlayer].UserId) then
			...
			SendNotify("c4xc4x gui",TargetedPlayer.." removed from whitelist.",5)
		else
			table.insert(ScriptWhitelist, Players[TargetedPlayer].UserId)
			SendNotify("c4xc4x gui",TargetedPlayer.." added to whitelist.", 5)
		end
	end
end)
...
Day_Button.MouseButton1Click:Connect(function()
	if Shaders_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(255,0,0) then
		...
		SendNotify("c4xc4x gui","Please turn off shaders.",5)
	end
end)
...
FreeEmotes_Button.MouseButton1Click:Connect(function()
	if not FreeEmotesEnabled then
		...
		SendNotify("c4xc4x gui","Loading free emotes.\nCredits: Gi#7331")
...
Players.PlayerRemoving:Connect(function(player)
	pcall(function()
		if player.Name == TargetedPlayer then
			UpdateTarget(nil)
			SendNotify("c4xc4x gui","Targeted player left/rejoined.",5)
		end
	end)
end)
...
plr.CharacterAdded:Connect(function(x)
	...
	if PotionDi_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionDi_Button)
		SendNotify("c4xc4x gui","PotionDick was automatically disabled due to your character respawn",5)
	end
	if PotionFling_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionFling_Button)
		SendNotify("c4xc4x gui","PotionFling was automatically disabled due to your character respawn",5)
	end
	if AntiRagdoll_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(AntiRagdoll_Button)
		SendNotify("c4xc4x gui","AntiRagdoll was automatically disabled due to your character respawn",5)
	end
	if SpamMines_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(SpamMines_Button)
		SendNotify("c4xc4x gui","SpamMines was automatically disabled due to your character respawn",5)
	end
	if Fly_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(Fly_Button)
		flying = false
		...
		KeyDownFunction:Disconnect()
		KeyUpFunction:Disconnect()
		SendNotify("c4xc4x gui","Fly was automatically disabled due to your character respawn",5)
	end
	...
	while task.wait(10) do
		pcall(function()
			...
			if version<GuiVersion then
				SendNotify("c4xc4x gui","You are not using the latest version, please run the script again.",5)
				task.wait(5)
				SysBroker:Destroy()
				game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
			end
...
SendNotify("c4xc4x gui","discord.gg/mbzmCap7VV",10)
setclipboard("https://discord.gg/mbzmCap7VV")
